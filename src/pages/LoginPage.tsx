    ...
    <div className="grid min-h-screen bg-white lg:grid-cols-2">
        ...
        <div className="relative flex h-full flex-col justify-between p-10 text-white">
          ...
          <div>
            <h2 className="font-display text-4xl font-extrabold leading-tight">
              Run your restaurant<br />in real time.
            </h2>
            <ul className="mt-6 space-y-3 text-sm text-orange-50/90">
              <li className="flex items-center gap-3"><ShoppingCart size={16} /> Cashier register with one-tap order entry</li>
              <li className="flex items-center gap-3"><Radio size={16} /> Live order feed — Dine-In · Takeaway · Delivery</li>
              <li className="flex items-center gap-3"><ChefHat size={16} /> Menu, tables & inventory in one dashboard</li>
            </ul>
          </div>
          <p className="text-xs text-orange-100/60">Restolink POS · powered by Supabase Realtime</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          ...
          <h1 className="font-display text-2xl font-bold text-zinc-900">Staff sign in</h1>
          <p className="mt-1 text-sm text-zinc-500">Access the dashboard, register & order feed.</p>

          <form onSubmit={submit} className="mt-8 space-y-4">
            <div>
              <label className="mb-1.5 block text-xs font-bold uppercase tracking-wide text-zinc-400">Email</label>
              <input
            ...
            <div>
              <label className="mb-1.5 block text-xs font-bold uppercase tracking-wide text-zinc-400">Password</label>
              <input
